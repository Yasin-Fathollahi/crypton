...
export default function SocialLogos() {
  return (
    <ul className="flex gap-4 text-gray-200/60">
      ...
      <li className={linkClasses}>
        <Link href="https://t.me/SomeRandomGuy00" className="p-1.5">
          <FaTelegram className="size-6" />
        </Link>
      </li>
      <li className={linkClasses}>
        <Link href="https://wa.me/qr/TDUR2PHEPIE7M1" className="p-1.5">
          <FaWhatsapp className="size-6" />
        </Link>
      </li>
      <li className={linkClasses}>
        <Link href="https://github.com/Yasin-Fathollahi" className="p-1.5">
